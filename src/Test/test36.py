...
if __name__ == "__main__":
    ...
    unittest.main(testRunner=HtmlTestRunner.HTMLTestRunner(output='C:\\Users\\dmefr\\OneDrive\\Escritorio\\FW_Python_Selenium_Pruebas_IntellijIdea\\FW_Python_Selenium_Intellij 2\\src\\reportes htmlrunner\\Resultado de mi test plan'))